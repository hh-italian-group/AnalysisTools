...
PdfPrinter::PdfPrinter(const std::string& _output_file_name, const draw_options::ItemCollection& opt_items,
...
PdfPrinter::LabelOptions& PdfPrinter::GetLabelOptions(const std::string& name)
{
...
void PdfPrinter::Print(const std::string& title, PlotDescriptor& desc, bool is_last)
{
...
PdfPrinter::Point PdfPrinter::GetAbsolutePosition(const std::string& name) const
{
    std::set<std::string> previous_names;
    return GetAbsolutePosition(name, previous_names);
}

PdfPrinter::Point PdfPrinter::GetAbsolutePosition(const std::string& name, std::set<std::string>& previous_names) const
{
...
void PdfPrinter::DrawLabel(const std::string& label_name, const LabelOptions& label_opt,
